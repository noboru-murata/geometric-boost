...
\label{sec:org741b0f3}
\subsection{majority vote}
\label{sec:orgbed6476}
\begin{frame}[label={sec:org9147118}]{Majority Vote}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orga7d992f}]{Ensemble Learning}
\begin{center}
\begin{tabular}{cc}
...
\end{alertblock}
\end{frame}
\begin{frame}[label={sec:org87beef7}]{Simple Example}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgcdcfb96}]{Effect of Boosting}
\begin{center}
obtained classifier
\end{center}
\begin{columns}
...
\label{sec:orge25962a}
\begin{frame}[label={sec:orge1775f1}]{normal mixture}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org9ba3101}]{global extension}
\begin{center}
\only<1| handout:0>{
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org0f96a0f}]{local extension}
\begin{center}
\only<1| handout:0>{
...
\label{sec:orgeb84d89}
\subsection{boosting algorithm}
\label{sec:org039f407}
\begin{frame}[label={sec:orge8e56eb}]{Problem Formulation}
\begin{itemize}
\item problem
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org8579a92}]{Boosting Algorithm (1)}
\begin{block}{(start)}
\begin{itemize}
\item \alert{input:}\\
\(n\) samples
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org2e234fb}]{Boosting Algorithm (2)}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgcc2f7c1}]{Boosting Algorithm (3)}
\begin{block}{(iteration)}
\begin{itemize}
\item \alert{step 2:}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org457c6fa}]{Boosting Algorithm (4)}
\begin{block}{(iteration)}
\begin{itemize}
\item \alert{step 3:}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org3f7c1a2}]{Boosting Algorithm (5)}
\begin{block}{(end)}
\begin{itemize}
\item \alert{output:}\\
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orga4f8d17}]{AdaBoost Algorithm}
...
\label{sec:orgc71651c}
\begin{frame}[label={sec:org171046b}]{Boosting Algorithm (1)}
\begin{block}{(start)}
\begin{itemize}
\item \alert{input:}\\
\(n\) samples
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org8d2aa9e}]{Boosting Algorithm (2)}
\begin{block}{(iteration)}
\begin{itemize}
\item \alert{step 1:}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org1fe6a11}]{}
\begin{center}
\includegraphics[width=.7\linewidth]{geoboost0}
\end{center}
\end{frame}
\begin{frame}[label={sec:org60adb8e}]{Boosting Algorithm (3)}
\begin{block}{(iteration)}
\begin{itemize}
\item \alert{step 2:}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org2a6c671}]{}
\begin{center}
\includegraphics[width=.7\linewidth]{geoboost1}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgd46e041}]{Boosting Algorithm (4)}
\begin{block}{(iteration)}
\begin{itemize}
\item \alert{step 3:}
update \(q_t\):
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org13555ab}]{}
\begin{center}
\includegraphics[width=.7\linewidth]{geoboost2}
\end{center}
\end{frame}
\begin{frame}[label={sec:org0a0bc13}]{}
\begin{center}
\includegraphics[width=.7\linewidth]{geoboost3}
\end{center}
\end{frame}
\begin{frame}[label={sec:org889381a}]{}
\begin{center}
\includegraphics[width=.7\linewidth]{geoboost4}
\end{center}
\end{frame}
\begin{frame}[label={sec:org98603c9}]{Boosting Algorithm (5)}
\begin{block}{(end)}
\begin{itemize}
\item \alert{output:} \\
construct a majority vote classifier:
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgcd3ac10}]{Mechanism of Boosting}
\begin{itemize}
...
\label{sec:orgb2712f5}
\subsection{toy examples}
\label{sec:org2dbe0d4}
\againframe{sec:org87beef7}
\begin{frame}[label={sec:org0ef47cf}]{}
\begin{center}
first round\\
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org5bec807}]{}
\begin{center}
second round\\
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgfeff946}]{}
\begin{center}
third round\\
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgea741fa}]{}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org678abbc}]{}
\begin{center}
...
\end{center}
\end{frame}
\againframe{sec:orgcdcfb96}
\begin{frame}[label={sec:orgd9411a1}]{Error Reduction by Boosting}
\begin{center}
...
\label{sec:orgc838a58}
\begin{frame}[label={sec:org7f57128}]{Real World Application}
\begin{exampleblock}{Face Detection}\label{sec:org8deab8c}
...
\end{frame}
\section{Conclusion}
\label{sec:org8972839}
\begin{frame}[label={sec:org00deafa}]{Concluding Remarks}
